...
| [前端设计规范 v0.13](docs/前端设计规范-v0.13.md) | 设计令牌、黑白双主题、无障碍控件、界面信息架构（以 Kimi 实测值为准） |
...
| [Wiki 生成调研 v0.1](docs/Wiki生成调研-v0.1.md) | 主流 Wiki 页面生成的四条路线、产品实例与可直接照抄的清单 |
...
> 已从工作区删除。旧文里出现的「撤回 v0.12 §2.4」这类指代仍然读得通——被撤回的内容
